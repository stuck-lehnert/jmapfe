...
export function UIShell({
  ...
  return (
    <View style={styles.shell}>
      <Toolbar view={view} mobile={mobile} showFoldersButton={mobile} onOpenFolders={onOpenFolders} onOpenMail={onOpenMail} onGetMessages={onGetMessages} onOpenSettings={onOpenSettings} />
